    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['system:shopInfoOwner:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['system:shopInfoOwner:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:shopInfoOwner:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:shopInfoOwner:export']"
        >导出</el-button>
      </el-col>
    </el-row>

    <el-table v-loading="loading" :data="shopInfoOwnerList" @selection-change="handleSelectionChange">
...
<script>
import { listShopInfo, getShopInfo, refresh,delShopInfo, addShopInfo, updateShopInfo, exportShopInfo } from "@/api/system/shopInfoOwner";
  ...
  methods: {
    ...
    getList() {
      ...
      listShopInfo(this.queryParams).then(response => {
        this.shopInfoOwnerList = response.rows;
